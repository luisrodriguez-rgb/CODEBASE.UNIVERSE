...
export const TRANSLATIONS = {
  en: {
    ...
    tab_calls: 'CALLS',
    tab_history: 'HISTORY',
    inspect_sec_metrics: 'METRICS',
    inspect_sec_role: 'ARCHITECTURAL ROLE',
    inspect_sec_risk: 'RISK ANALYSIS',
    inspect_sec_actions: 'QUICK ACTIONS',
    inspect_centrality: 'CENTRALITY',
    inspect_importance: 'IMPORTANCE',
    inspect_risk: 'STRUCTURAL RISK',
    inspect_complexity: 'COMPLEXITY',
    inspect_dependents: 'DEPENDENTS',
    inspect_dependencies: 'CALLS',
    inspect_loc: 'LOC',
    inspect_size: 'SIZE',
    inspect_why_title: 'Why?',
    btn_quick_explore: 'Explore Path',
    btn_quick_whatif: 'What-If Sim',
    btn_quick_refactor: 'Refactor Arena',
    ...
    inspect_callers: 'DIRECT CALLERS / INBOUND',
  ...
  es: {
    ...
    inspect_sec_metrics: 'MÉTRICAS',
    inspect_sec_role: 'ROL ARQUITECTÓNICO',
    inspect_sec_risk: 'ANÁLISIS DE RIESGO',
    inspect_sec_actions: 'ACCIONES RÁPIDAS',
    inspect_centrality: 'CENTRALIDAD',
    inspect_importance: 'IMPORTANCIA',
    inspect_risk: 'RIESGO ESTRUCTURAL',
    inspect_complexity: 'COMPLEJIDAD',
    inspect_dependents: 'DEPENDIENTES',
    inspect_dependencies: 'LLAMADAS',
    inspect_loc: 'LOC',
    inspect_size: 'TAMAÑO',
    inspect_why_title: '¿Por qué?',
    btn_quick_explore: 'Explorar Ruta',
    btn_quick_whatif: 'Simulación What-If',
    btn_quick_refactor: 'Arena de Refactor',
